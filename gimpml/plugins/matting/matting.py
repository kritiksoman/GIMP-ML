...
def matting(procedure, image, n_drawables, drawables, force_cpu, progress_bar, config_path_output):
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        while True:
            ...
            if response == Gtk.ResponseType.OK:
                ...
                result = matting(procedure, image, n_drawables, layer, force_cpu, progress_bar, config_path_output)
