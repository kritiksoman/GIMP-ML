...
def k_means(procedure, image, drawable, n_cluster, position, progress_bar, config_path_output):
    ...
    with open(os.path.join(weight_path, '..', 'gimp_ml_run.pkl'), 'wb') as file:
        pickle.dump({"n_cluster": int(n_cluster), "position": bool(position), "inference_status": "started"}, file)
    ...
    if run_mode == Gimp.RunMode.INTERACTIVE:
        ...
        while True:
            ...
            if response == Gtk.ResponseType.OK:
                ...
                result = k_means(procedure, image, layer, n_cluster, position, progress_bar, config_path_output)
